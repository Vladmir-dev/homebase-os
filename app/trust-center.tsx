...
export default function TrustCenterScreen() {
  ...
  const bandColor = (band?: string) => {
    if (band === 'strong' || band === 'excellent') return '#2e7d32';
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
              ...
              <View style={styles.itemCard}>
                ...
                <View style={[styles.itemRow, summary.asset.chain_valid ? styles.chainValidRow : styles.chainBrokenRow]}>
                  <Ionicons
                    ...
                    size={18}
                    color={summary.asset.chain_valid ? '#2e7d32' : '#c62828'}
                  />
                  <Text style={styles.itemLabel}>Hash Chain Integrity</Text>
                  <Text style={[styles.itemValue, { color: summary.asset.chain_valid ? '#2e7d32' : '#c62828' }]}>
          ...
          {summary.strikes && summary.strikes.length === 0 && (
            <View style={styles.cleanPanel}>
              <Ionicons name="sparkles-outline" size={20} color="#2e7d32" />
...
const styles = StyleSheet.create({
  ...
  itemValue: { color: '#1b5e20', fontSize: 14, fontWeight: '800', textTransform: 'capitalize' },
  itemMeta: { color: '#4c8c4a', fontSize: 12, marginTop: 4 },
  chainValidRow: { backgroundColor: '#e8f5e9', borderRadius: 6, padding: 6, marginTop: 4 },
  ...
  cleanText: { color: '#2e7d32', fontSize: 13, fontWeight: '700', flex: 1 },
  primaryButton: { minHeight: 46, backgroundColor: '#2e7d32', borderRadius: 8, alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: 8, marginTop: 6 },
